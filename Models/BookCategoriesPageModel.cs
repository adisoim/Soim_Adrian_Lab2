...
namespace Soim_Adrian_Lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Soim_Adrian_Lab2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Soim_Adrian_Lab2Context context,
